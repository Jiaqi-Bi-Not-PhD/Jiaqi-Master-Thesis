...
\gradyear{2024}
\author{Jiaqi Bi}
\title{Frailty Model Incorporating Ascertainment Correction with Missing Data in Family-Based Study}
...
\begin{dedication}
    ...
    \textit{To my mother, Kai Hua, for all the upbringrings. }

    \textit{To my father, Guangmin Bi, for teaching me not to give up. }
    
    \textit{To my supervisors, for their unstopping guidance and invaluable lessons. }

    \textit{To my friends, for their peer pressures and supports, and their companionships.}
...
\bibliography{westernthesis.bib}
