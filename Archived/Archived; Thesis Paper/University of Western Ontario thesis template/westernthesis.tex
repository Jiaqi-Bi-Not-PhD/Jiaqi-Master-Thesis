...
\newcommand{\super}{Dr. Yun-Hee Choi} %supervisor
\newcommand{\superj}{Dr. Osvaldo Espin-Garcia} %joint supervisor, if there is one, leave blank if not (lbin)... only one of the three.
...
\newcommand{\sco}{Dr. }  %member of supervisory committee
\newcommand{\sct}{Dr. }  %other member of supervisory committee (lbin)
...
\newcommand{\firstname}{Jiaqi}
\newcommand{\middlename}{}
\newcommand{\lastname}{Bi}
...
\bibliographystyle{unsrtnat} % (change according to your preference)
