...
Denote $\mathbf{X}_{j}\sim MVN(\boldsymbol{\mu}_j, \boldsymbol{\Sigma}_j)$ such that $\mathbf{X}_j$ is the vector of the PRS among all subjects in family $j$. 
Also note $\mathbf{X}_j=(x_{1,j}, x_{2,j},..., x_{n_j, j})^{\top}$. 
