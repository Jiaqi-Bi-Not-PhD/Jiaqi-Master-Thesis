...
\begin{enumerate} 
    ...
    \item Obtain $E(y_{mis,i}|\mathbf{y}_{-i})=\mu_i^*+\hat{\boldsymbol{\Sigma}}_{i,-i}\hat{\boldsymbol{\Sigma}}_{-i,-i}^{-1}(\mathbf{x}_{-i}-\boldsymbol{\mu}^*_{-i})$
    \item Draw $w_{2i}\sim N(0,1)$
    \item Impute $y_{mis,i}=E(y_{mis,i}|\mathbf{y}_{-i}) + w_{2i}\hat{\sigma}_i$
    \item Repeat 3. to 9. for $M$ times to obtain $M$ complete datasets.
\end{enumerate}
